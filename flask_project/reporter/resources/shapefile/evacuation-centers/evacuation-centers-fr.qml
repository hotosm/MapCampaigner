...
<qgis version="2.12.1-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{e45beec7-9934-4dd0-9c53-15f37a715af5}">
      <rule filter="TYPE = 'Hospital' OR TYPE = 'Clinic'" key="{baa2eb6f-602f-4605-b1a9-b2d23bf6aba5}" symbol="0" label="Hôpital"/>
      ...
      <rule filter="TYPE = 'School' OR TYPE = 'University/College'" key="{d0265b96-f2bc-4c40-a9c1-d9fa480b9593}" symbol="2" label="École/Université"/>
      <rule filter="TYPE = 'Public Building'" key="{e4c3292d-8b7c-4f18-8193-025494aab422}" symbol="3" label="Bâtiment public"/>
      <rule filter="ELSE" key="{50cdcb78-cee4-4167-9cba-5dab04a3bf3a}" symbol="4" label="Autre"/>
    </rules>
    <symbols>
