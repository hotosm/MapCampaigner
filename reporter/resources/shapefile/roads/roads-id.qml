  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="25000" scalemindenom="1" label="1:25000">
        <rule filter="&quot;TYPE&quot; = 'Motorway or highway'" symbol="0" label="Jalan tol"/>
        <rule filter="&quot;TYPE&quot; = 'Motorway link'" symbol="1" label="Penghubung jalan tol"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" symbol="2" label="Jalan arteri"/>
        <rule filter="&quot;TYPE&quot; = 'Primary link'" symbol="3" label="Penghubung jalan arteri"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary'" symbol="4" label="Jalan tersier"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary link'" symbol="5" label="Penghubung jalan tersier"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary'" symbol="6" label="Jalan kolektor"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary link'" symbol="7" label="Penghubung jalan kolektor"/>
        <rule filter="&quot;TYPE&quot; = 'Road, residential, living street, etc.'" symbol="8" label="Jalan, pemukiman, jalan hidup, dll."/>
        <rule filter="&quot;TYPE&quot; = 'Track'" symbol="9" label="Trek"/>
        <rule filter="&quot;TYPE&quot; = 'Cycleway, footpath, etc.'" symbol="10" label="Jalan sepeda, jalan setapak, dll."/>
      </rule>
      <rule scalemaxdenom="50000" symbol="11" scalemindenom="25001" label="25k to 50k">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway'" symbol="12" label="Penghubung jalan tol"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" symbol="13" label="Jalan arteri"/>
      </rule>
      <rule scalemaxdenom="10000000" symbol="14" scalemindenom="50001" label="50k +">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway' " symbol="15" label="Penghubung jalan tol"/>
      </rule>
    </rules>
    <symbols>
