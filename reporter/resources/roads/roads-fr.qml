  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="25000" scalemindenom="1" label="1:25000">
        <rule filter="&quot;TYPE&quot; = 'Motorway or highway'" symbol="0" label="Autoroute ou voie rapide"/>
        <rule filter="&quot;TYPE&quot; = 'Motorway link'" symbol="1" label="Bretelle voie rapide"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" symbol="2" label="Route primaire"/>
        <rule filter="&quot;TYPE&quot; = 'Primary link'" symbol="3" label="Bretelle route primaire"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary'" symbol="4" label="Tertiaire"/>
        <rule filter="&quot;TYPE&quot; = 'Tertiary link'" symbol="5" label="Bretelle tertiaire"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary'" symbol="6" label="Secondaire"/>
        <rule filter="&quot;TYPE&quot; = 'Secondary link'" symbol="7" label="Bretelle secondaire"/>
        <rule filter="&quot;TYPE&quot; = 'Road, residential, living street, etc.'" symbol="8" label="Route locale, rue résidentielle, etc."/>
        <rule filter="&quot;TYPE&quot; = 'Track'" symbol="9" label="Chemin carrossable"/>
        <rule filter="&quot;TYPE&quot; = 'Cycleway, footpath, etc.'" symbol="10" label="Voie piétonne, cyclable, etc."/>
      </rule>
      <rule scalemaxdenom="50000" symbol="11" scalemindenom="25001" label="25k to 50k">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway'" symbol="12" label="Autoroute ou voie rapide"/>
        <rule filter="&quot;TYPE&quot; = 'Primary road'" symbol="13" label="Primaire"/>
      </rule>
      <rule scalemaxdenom="10000000" symbol="14" scalemindenom="50001" label="50k +">
        <rule filter=" &quot;TYPE&quot;  =  'Motorway or highway' " symbol="15" label="Autoroute ou voie rapide"/>
      </rule>
    </rules>
    <symbols>
